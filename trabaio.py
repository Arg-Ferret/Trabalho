...
print("Teste 5/1: Vendo se esta vazia parte 1")
fila.is_empty()
print(fila)	

print("Teste 6: Vendo se esta cheio")
fila.is_full()
print(fila)	

print("Teste 7: Esvaziando a fila de vez")
fila.clear()
print(fila)

print("Teste 5/2: Vendo se esta vazia parte 2")
fila.is_empty()
print(fila)	